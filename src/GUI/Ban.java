...
//        
        ...
        tTrangThai.setPreferredSize(new Dimension(tMaBan.getPreferredSize().width,30));
        ...
        panel_5.setPreferredSize(new Dimension(left_content.getPreferredSize().width,650));
