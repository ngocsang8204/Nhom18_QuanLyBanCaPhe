...
public class QLNhaCungCap extends JPanel implements ActionListener, MouseListener {
    ...
    public QLNhaCungCap() {
        ...
        // panel_trong.setPreferredSize(new
        // Dimension(panel_2.getPreferredSize().width,200));
        ...
        panel_11.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255),
        ...
        if (btn.equals(btnXoaRong)) {
            ...
            if (kiemTra()) {
                ...
                if (dung) {
                    ...
                    JOptionPane.showMessageDialog(this, "Sửa nhà cung cấp không thành công");
                xoaRong();
                hienBang();
            }
    ...
    public boolean kiemTra() {
        ...
        if (tTenNhaCungCap.getText().length() <= 0 || tThongTinLienHe.getText().length() <= 0
                || tDiaChi.getText().length() <= 0) {
